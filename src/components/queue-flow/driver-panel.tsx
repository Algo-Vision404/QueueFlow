    ...
    switch (driverStatus) {
      case 'offline':
        return (
          <div className="text-center space-y-4 py-6">
            <div className="w-16 h-16 rounded-full bg-cashew flex items-center justify-center mx-auto">
            ...
            <Button
              size="lg"
              className="h-14 w-full max-w-xs mx-auto text-base bg-foreground text-background hover:bg-foreground/90 shadow-lg rounded-xl"
      ...
      case 'available':
        return (
          <div className="text-center space-y-4 py-6">
            <div className="w-16 h-16 rounded-full bg-cashew flex items-center justify-center mx-auto">
              <Clock className="w-8 h-8 text-foreground animate-pulse" />
            </div>
            <div>
            ...
            <Button
              variant="outline"
              size="lg"
              className="h-12 w-full max-w-xs mx-auto text-sm"
        ...
        return (
          <div className="space-y-4 py-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                size="lg"
                className="h-12 text-sm bg-foreground text-background hover:bg-foreground/90 shadow-md"
      ...
      <Card className="glass-card">
        <CardContent className="p-3 md:p-5">
          <div className="flex items-start justify-between gap-3">
            ...
            <Badge className={`text-[10px] border-0 font-semibold flex-shrink-0 ${statusConfig[driverStatus].className}`}>
      ...
      <Card className="glass-card">
        ...
        <CardContent className="px-3 pb-3">
          <div className="space-y-2">
            {trips.map((trip) => (
              <div key={trip.id} className="flex items-center justify-between py-1.5 border-b border-border last:border-0">
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-cashew flex items-center justify-center flex-shrink-0">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Card className="glass-card text-center">
          <CardContent className="p-3 space-y-0.5">
            ...
            <p className="text-xl font-bold">{todayTrips}</p>
        ...
        <CardContent className="space-y-3 px-3 pb-3">
          ...
          <div className="space-y-0">
            <div className="flex items-center justify-between py-2 border-b border-border">
              ...
              <span className="text-xs font-semibold">{todayTrips}</span>
            </div>
            <div className="flex items-center justify-between py-2 border-b border-border">
              <span className="text-xs text-muted-foreground flex items-center gap-1.5">
              ...
              <span className="text-xs font-semibold">{totalPassengers}</span>
            </div>
            <div className="flex items-center justify-between py-2 border-b border-border">
              <span className="text-xs text-muted-foreground flex items-center gap-1.5">
              ...
              <span className="text-xs font-semibold">${faresCollected.toFixed(2)}</span>
            </div>
            <div className="flex items-center justify-between py-2 border-b border-border">
              <span className="text-xs text-muted-foreground flex items-center gap-1.5">
